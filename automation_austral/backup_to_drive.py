...
# Mapping día semana → file_id en Drive (carpeta "Mi Odoo AUSTRAL" (raiz))
DAY_FILE_IDS = {
    0: "1l7dmt3Xytz7bnm8xnOoZkkbWlvmNdiQf",   # LUNES (Monday=0)
    1: "1h5pa09ja3RdiZ51XnJyjQCaziPxIzuC6",   # MARTES
    2: "1v5GYoyvPHff7DweVIMOyyM343FWaOb9c",   # MIERCOLES
    3: "1cp7X8g90MTxVw29c_ud6jVBGjRVHJSL-",   # JUEVES
    4: "1SIYtd1z_hxGLxKFbpXRaC4MhWxKupZNe",   # VIERNES
    5: "1Tu_s-HObbeWQ-ldrEu_71t4tT3KfLm5B",   # SABADO
    6: "10_YKTn-t7Nz8sXBAToZz6NGhlB2GGUjP",   # DOMINGO
}
DAY_NAMES = ["LUNES", "MARTES", "MIERCOLES", "JUEVES", "VIERNES", "SABADO", "DOMINGO"]

DB_NAME = "cararjfam_test"
FILESTORE = "/opt/odoo17/.local/share/Odoo/filestore/cararjfam_test"
CUSTOM_ADDONS = "/opt/odoo17/custom-addons"
AUTOMATION_DIR = "/opt/automation_austral"
